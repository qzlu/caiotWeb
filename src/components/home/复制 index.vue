...
<script>
	import childSelect from './count_select.vue' //中间图片
...
.home .notice_green{ overflow: hidden; background: #02961a;}
	...
	.header_item .list_a ul li{ width: 125px; height: 80px; float: left; cursor: pointer; }
	.header_item .list_a ul li.active{background: url(/static/image/index/nav_sel_font.png) 1px 131px;}
